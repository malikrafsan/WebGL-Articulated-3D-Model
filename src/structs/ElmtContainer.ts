export class ElmtContainer {
  ...
  public createButton(props: {
    ...
    btn.className = "ml-" + depth*5 + " mt-2 w-1/3 flex flex-col items-center py-1 bg-purple-600 border border-slate-900/10 text-xs font-bold rounded-lg active:bg-violet-500";
    btn.innerHTML = id;
